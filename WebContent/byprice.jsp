...
<%
String sp=request.getParameter("price");
Context ctx=new InitialContext();
DataSource ds=(DataSource)ctx.lookup("java:OracleDS");
Connection con=ds.getConnection();
PreparedStatement ps;
	StringTokenizer st=new StringTokenizer(sp,"-");
	String lp=st.nextToken();
	String up=st.nextToken();
	ps=con.prepareStatement("select * from item_details where i_price between ? and ?");
	ps.setDouble(1,Double.parseDouble(lp));
	ps.setDouble(2,Double.parseDouble(up));
