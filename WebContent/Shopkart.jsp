...
<li>  <a href="Confirm.jsp"> | Items In Cart </a></li>
</ul>
...
ps=con.prepareStatement("select * from item_details where rownum<=9");
ResultSet rs=ps.executeQuery();
ArrayList<Phone1> al=new ArrayList<Phone1>();
while(rs.next())	
{
	session.setAttribute("i_brand",rs.getString(7));
...
<% for(int i=0;i<al.size();i+=3)
{
	...
	Phone1 ph2=(Phone1)al.get(i+1);
	Phone1 ph3=(Phone1)al.get(i+2);
...
<td class="three">
<img src=<%=ph2.getImgpath() %> border="2" height=150 width=150><br><%=ph2.getSet_name() %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br><a href="Features.jsp?code=<%=ph2.getSet_no() %>">More Details</a></td>
<td class="four">
<img src=<%=ph3.getImgpath() %> border="2" height=150 width=150><br><%=ph3.getSet_name() %><br><a href="Features.jsp?code=<%=ph3.getSet_no() %>">More Details</a></td>
</tr>
<br>
